...
index_img: /img/cc/privacy_index.jpg
archive: true
tags:
    - Cryptography
...
![MPC 示例说明：工人A 选择一个随机数 W，将其添加到其工资中，然后将总和传递给 工人B，工人B 将其工资添加到该总和中，然后将其传递给 工人C，依此类推。工人A 得到最终总和，并可以计算平均工资](/img/cc/privacy1.png)
...
![姓名和电子邮件地址的简单标记化系统](/img/cc/privacy2.png)
...
![使用数据隐私保险库，敏感数据在采集时被发送到保险库，之后下游存储令牌化数据](/img/cc/privacy4.png)
